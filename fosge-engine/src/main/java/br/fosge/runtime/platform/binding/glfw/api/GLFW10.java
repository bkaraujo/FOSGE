...
public interface GLFW10 {
    ...
    /**
     * Returns the value of the GLFW timer. Unless the timer has been set using {@link br.fosge.runtime.platform.binding.GLFW#glfwSetTime SetTime}, the timer measures time elapsed since GLFW was initialized.
     *
     ...
     * with calls to {@link br.fosge.runtime.platform.binding.GLFW#glfwSetTime SetTime}.</p>
     *
     ...
     * to input text, use {@link br.fosge.runtime.platform.binding.GLFW#glfwSetCharCallback SetCharCallback} instead.</p>
     *
     ...
     * transparently re-centers it and provides unconstrained cursor motion. See {@link br.fosge.runtime.platform.binding.GLFW#glfwSetInputMode SetInputMode} for more information.</p>
     *
     ...
     *
     * <p>If you wish to update the refresh rate of the desired video mode in addition to its resolution, see {@link br.fosge.runtime.platform.binding.GLFW#glfwSetWindowMonitor SetWindowMonitor}.</p>
     *
     ...
     * window in pixels, see {@link br.fosge.runtime.platform.binding.GLFW#glfwGetFramebufferSize GetFramebufferSize}.
     *
     ...
     * {@link br.fosge.runtime.platform.binding.GLFW#glfwGetWindowAttrib GetWindowAttrib} and {@link #glfwGetWindowSize GetWindowSize} and {@link br.fosge.runtime.platform.binding.GLFW#glfwGetFramebufferSize GetFramebufferSize}.</p>
     *
     ...
     *
     * <p>Once you have created the window, you can switch it between windowed and full screen mode with {@link br.fosge.runtime.platform.binding.GLFW#glfwSetWindowMonitor SetWindowMonitor}. If the window has an OpenGL or
     ...
     * is present, the {@code IDI_APPLICATION} icon will be used instead. To set a different icon, see {@link br.fosge.runtime.platform.binding.GLFW#glfwSetWindowIcon SetWindowIcon}.</li>
